...
<form name="output_form" method="post" action="db_del.php"
  ...
  <tr>
      <td align=right colspan=5> page_num / page_max</td>
  </tr>
  <tr bgcolor=#afbab9>
      <td align=center width=7%><tt><b>번호</b></tt></td>
      <td align=center width=15%><tt><b>이름</b></tt></td>
      <td align=center colspan=4><tt><b>내용</b></tt></td>
  </tr> 
  <tr>
      &nbsp;
  </tr>
       ...
       if( file_exists("file_db"))
       {
	     ...
	     for($i=1 ; $i<= $metastr_len ;$i++)
	     {
		   ...
		   if( ($i%2) == 0 ) echo (" <tr bgcolor=#dde2d1> ");
	           else  echo (" <tr bgcolor=#Ebeeee > ");
		   //파일에서 읽어 드려온 게시물 내용을 출력
		   echo ("
		   <td><tt>$i</tt></td>
	           <td><tt>$metastr[$key_name]</tt></td>
	           <td colspan=4><tt> $metastr[$key_con]
	           </tt></td>
	           </tr><tr></tr>");
